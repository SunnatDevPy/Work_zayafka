...
_UI: dict[str, dict[str, str]] = {
    LANG_RU: {
        ...
        "hr_survey_skipped_pay_salary": "— (не заполняется при частичной или проектной занятости)",
    ...
    LANG_UZ: {
        ...
        "hr_survey_skipped_pay_salary": "— (qisman yoki loyihaviy bandlikda to‘ldirilmaydi)",
